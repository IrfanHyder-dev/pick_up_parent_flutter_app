    ...
    return TextFormField(
      ...
      decoration: InputDecoration(
        ...
        errorBorder: widget.isDecorationEnable ?? false
            ? inputBorder()
            : InputBorder.none,
        focusedErrorBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(widget.borderRadius),
            borderSide: BorderSide(
              color: Colors.red,
              width: 1,
            )),
        focusedBorder: inputFocusBorder(color: primaryColor),
            ...
            (widget.prefixIcon != null
                ...
                : widget.prefixImage != null
                    ? Container(
                        height: 24,
                        width: 24,
                        margin: const EdgeInsetsDirectional.only(end: 15, start: 16),
